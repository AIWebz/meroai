...
// facts.responseFormat === "json" switches to a structured-data generation
// mode (used for AI-authored website copy) instead of the short in-character
// chat persona — kept in sync with src/ai/systemPrompt.ts on the frontend.
